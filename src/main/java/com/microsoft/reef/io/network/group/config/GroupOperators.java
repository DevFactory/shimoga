...
public class GroupOperators {
   ...
   *
   * @return {@link Builder} to build the {@link Scatter} Operator
   */
   ...
   *
   * @return {@link Builder} to build the {@link Broadcast} Operator
   */
   ...
   *
   * @return {@link Builder} to build the {@link Gather} Operator
   */
   ...
   *
   * @return {@link Builder} to build the {@link Reduce} Operator
   */
   ...
   *
   * @return {@link Builder} to build the {@link AllGather} Operator
   */
   ...
   *
   * @return {@link Builder} to build the {@link AllReduce} Operator
   */
   ...
   *
   * @return {@link Builder} to build {@link ReduceScatter} operator
   */
